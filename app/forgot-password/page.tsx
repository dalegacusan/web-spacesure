      ...
      <div className="min-h-screen bg-[#3B4A9C] flex items-center justify-center px-4">
        <div className="bg-[#3B4A9C] p-6 sm:p-8 w-full max-w-md">
          <div className="mb-6 sm:mb-8">
            ...
            <h1 className="text-2xl sm:text-4xl font-bold text-white mb-4">Check Your Email</h1>
          ...
          <div className="space-y-4">
            <p className="text-white/80">Didn't receive the email? Check your spam folder or try again.</p>
          ...
          <div className="text-center mt-8 space-y-2">
            <p className="text-white/60">About Us</p>
    ...
    <div className="min-h-screen bg-[#3B4A9C] flex items-center justify-center px-4">
      <div className="bg-[#3B4A9C] p-6 sm:p-8 w-full max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-white/80 text-sm sm:text-base">Enter your email to reset your password</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div>
            <Label htmlFor="email" className="text-white text-base sm:text-lg mb-2 block">
              Email Address
            </Label>
            <Input
              id="email"
