...
// Suspense-safe search param reader
        ...
        <Card className='mb-6 border-red-200'>
          ...
          <CardContent className='space-y-4'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
              <Detail label='Error Code' value={updatedDetails.errorCode} />
              <Detail
                label='Error Message'
                value={updatedDetails.errorMessage}
              />
              <Detail
                label='Reference No.'
            ...
            <div className='border-t pt-4'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                <Detail
                  label='Masked Card'
                  value={updatedDetails.fundSource?.details?.masked}
                />
                <Detail
                  label='Issuer'
                  value={updatedDetails.fundSource?.details?.issuer}
                />
              </div>
            </div>
